...
const values1=['北京', '天津', '河北', '山西', '内蒙古', '辽宁', '吉林', '黑龙江', '上海', '江苏', '浙江', '安徽', '福建', '江西', '山东', '河南',
...
const values3= [
  ...
  const values4=[
    ...
    [// ['130100', '130200', '130300', '130400', '130500', '130600', '130700', '130800', '130900', '131000', '131100'],
      ...
      ['路南区','路北区','古冶区','开平区','丰南区','丰润区','滦县','滦南县','乐亭县','迁西县','玉田县','曹妃甸区','遵化市','迁安市'],
    ...
    [// ['140100', '140200', '140300', '140400', '140500', '140600', '140700', '140800', '140900', '141000', '141100'],
      ...
      ['城区','矿区','郊区','平定县','盂县'],
      ['长治县','襄垣县','屯留县','平顺县','黎城县','壶关县','长子县','武乡县','沁县','沁源县','潞城市','城区','郊区'],
    ...
    [// ['210100', '210200', '210300', '210400', '210500', '210600', '210700', '210800', '210900', '211000', '211100', '211200', '211300', '211400'],
      ['和平区','沈河区','大东区','皇姑区','铁西区','苏家屯区','东陵区','于洪区','辽中县','康平县','法库县','新民市','沈北新区'],
    ...
    [//  ['220100', '220200', '220300', '220400', '220500', '220600', '220700', '220800', '222400'],
      ...
      ['浑江区','抚松县','靖宇县','长白朝鲜族自治县','江源区','临江市'],
      ['宁江区','前郭尔罗斯蒙古族自治县','长岭县','乾安县','扶余市'],
      ['洮北区','镇赉县','通榆县','洮南市','大安市'],
      ['延吉市','图们市','敦化市','珲春市','龙井市','和龙市','汪清县','安图县'],
    ],
    [// ['230100', '230200', '230300', '230400', '230500', '230600', '230700', '230800', '230900', '231000', '231100', '231200', '232700'],
      ['道里区','南岗区','道外区','香坊区','平房区','松北区','呼兰区','依兰县','方正县','宾县','巴彦县','木兰县','通河县','延寿县','阿城区','双城市','尚志市','五常市'],
    ...
    [// ['320100', '320200', '320300', '320400', '320500', '320600', '320700', '320800', '320900', '321000', '321100', '321200', '321300'],
      ...
      ['鼓楼区','云龙区','贾汪区','泉山区','丰县','沛县','铜山区','睢宁县','新沂市','邳州市'],
      ['天宁区','钟楼区','戚墅堰区','新北区','武进区','溧阳市','金坛市'],
      ['虎丘区','吴中区','相城区','姑苏区','常熟市','张家港市','昆山市','吴江区','太仓市'],
      ...
      ['广陵区','邗江区','宝应县','仪征市','高邮市','江都区'],
      ['京口区','润州区','丹徒区','丹阳市','扬中市','句容市'],
      ['海陵区','高港区','兴化市','靖江市','泰兴市','姜堰区'],
      ['宿城区','宿豫区','沭阳县','泗阳县','泗洪县'],
    ],
    [// ['330100', '330200', '330300', '330400', '330500', '330600', '330700', '330800', '330900', '331000', '331100'],
    ...
    [// ['340100', '340200', '340300', '340400', '340500', '340600', '340700', '340800', '341000', '341100', '341200', '341300', '341500', '341600', '341700', '341800'],
      ['瑶海区','庐阳区','蜀山区','包河区','长丰县','肥东县','肥西县','巢湖市','庐江县'],
    ...
    [// ['360100', '360200', '360300', '360400', '360500', '360600', '360700', '360800', '360900', '361000', '361100'],
      ...
      ['昌江区','珠山区','浮梁县','乐平市'],
      ['安源区','湘东区','莲花县','上栗县','芦溪县'],
      ['庐山区','浔阳区','九江县','武宁县','修水县','永修县','德安县','星子县','都昌县','湖口县','彭泽县','瑞昌市','共青城市'],
      ['渝水区','分宜县'],
      ['月湖区','余江县','贵溪市'],
    ...
    [// ['420100', '420200', '420300', '420500', '420600', '420700', '420800', '420900', '421000', '421100', '421200', '421300', '422800', '429004', '429005', '429006', '429021'],
      ...
      ['沙嘴街道','干河街道','龙华山办事处','郑场镇','毛嘴镇','豆河镇','三伏潭镇','胡场镇','长倘口镇','西流河镇','沙湖镇','杨林尾镇','彭场镇','张沟镇','郭河镇','沔城回族镇','通海口镇','陈场镇','工业园区','九合垸原种场','沙湖原种场','五湖渔场','赵西垸林场','畜禽良种场','排湖风景区'],
    ...
    [// ['430100', '430200', '430300', '430400', '430500', '430600', '430700', '430800', '430900', '431000', '431100', '431200', '431300', '433100'],
      ['芙蓉区','天心区','岳麓区','开福区','雨花区','长沙县','望城区','宁乡县','浏阳市'],
    ...
    [// ['440100', '440200', '440300', '440400', '440500', '440600', '440700', '440800', '440900', '441200', '441300', '441400', '441500', '441600', '441700', '441800', '441900', '442000', '442101', '445100', '445200', '445300'],
      ...
      ['江城区','阳西县','阳东县','阳春市'],
      ['清城区','佛冈县','阳山县','连山壮族瑶族自治县','连南瑶族自治县','清新区','英德市','连州市'],
      ['东城街道','南城街道','万江街道','莞城街道','石碣镇','石龙镇','茶山镇','石排镇','企石镇','横沥镇','桥头镇','谢岗镇','东坑镇','常平镇','寮步镇','樟木头镇','大朗镇','黄江镇','清溪镇','塘厦镇','凤岗镇','大岭山镇','长安镇','虎门镇','厚街镇','沙田镇','道滘镇','洪梅镇','麻涌镇','望牛墩镇','中堂镇','高埗镇','松山湖管委会','虎门港管委会','东莞生态园'],
      ['石岐区街道','东区街道','火炬开发区街道','西区街道','南区街道','五桂山街道','小榄镇','黄圃镇','民众镇','东凤镇','东升镇','古镇镇','沙溪镇','坦洲镇','港口镇','三角镇','横栏镇','南头镇','阜沙镇','南朗镇','三乡镇','板芙镇','大涌镇','神湾镇'],
      [''],
      ['湘桥区','潮安区','饶平县'],
      ['榕城区','揭东区','揭西县','惠来县','普宁市'],
      ['云城区','新兴县','郁南县','云安县','罗定市'],
    ...
    [// ['450100', '450200', '450300', '450400', '450500', '450600', '450700', '450800', '450900', '451000', '451100', '451200', '451300', '451400'],
      ...
      ['秀峰区','叠彩区','象山区','七星区','雁山区','阳朔县','临桂区','灵川县','全州县','兴安县','永福县','灌阳县','龙胜各族自治县','资源县','平乐县','荔浦县','恭城瑶族自治县'],
    ...
    [// ['460100', '460200', '460300', '469001', '469002', '469003', '469005', '469006', '469007', '469025', '469026', '469027', '469028', '469030', '469031', '469033', '469034', '469035', '469036'],
      ...
      ['金江镇','老城镇','瑞溪镇','永发镇','加乐镇','文儒镇','中兴镇','仁兴镇','福山镇','桥头镇','大丰镇','国营红光农场','国营西达农场','国营金安农场'],
    ...
    [// ['500100'],
      ['万州区','涪陵区','渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','渝北区','巴南区','黔江区','长寿区','綦江区','潼南县','铜梁县','大足区','荣昌县','璧山县','梁平县','城口县','丰都县','垫江县','武隆县','忠县','开县','云阳县','奉节县','巫山县','巫溪县','石柱土家族自治县','秀山土家族苗族自治县','酉阳土家族苗族自治县','彭水苗族土家族自治县','江津区','合川区','永川区','南川区'],
    ],
    [// ['510100', '510300', '510400', '510500', '510600', '510700', '510800', '510900', '511000', '511100', '511300', '511400', '511500', '511600', '511700', '511800', '511900', '512000', '513200', '513300', '513400'],
      ['锦江区','青羊区','金牛区','武侯区','成华区','龙泉驿区','青白江区','新都区','温江区','金堂县','双流县','郫县','大邑县','蒲江县','新津县','都江堰市','彭州市','邛崃市','崇州市'],
      ['自流井区','贡井区','大安区','沿滩区','荣县','富顺县'],
      ['东区','西区','仁和区','米易县','盐边县'],
      ['江阳区','纳溪区','龙马潭区','泸县','合江县','叙永县','古蔺县'],
      ['旌阳区','中江县','罗江县','广汉市','什邡市','绵竹市'],
      ['涪城区','游仙区','三台县','盐亭县','安县','梓潼县','北川羌族自治县','平武县','江油市'],
      ['利州区','昭化区','朝天区','旺苍县','青川县','剑阁县','苍溪县'],
      ['船山区','安居区','蓬溪县','射洪县','大英县'],
      ['市中区','东兴区','威远县','资中县','隆昌县'],
      ['市中区','沙湾区','五通桥区','金口河区','犍为县','井研县','夹江县','沐川县','峨边彝族自治县','马边彝族自治县','峨眉山市'],
      ['东坡区','仁寿县','彭山县','洪雅县','丹棱县','青神县'],
      ['翠屏区','宜宾县','南溪区','江安县','长宁县','高县','珙县','筠连县','兴文县','屏山县'],
    ...
    [// ['520100', '520200', '520300', '520400', '522200', '522300', '522400', '522600', '522700'],
      ['南明区','云岩区','花溪区','乌当区','白云区','开阳县','息烽县','修文县','观山湖区','清镇市'],
      ['钟山区','六枝特区','水城县','盘县'],
    ...
    [// ['530100', '530300', '530400', '530500', '530600', '530700', '530800', '530900', '532300', '532500', '532600', '532800', '532900', '533100', '533300', '533400'],
      ...
      ['个旧市','开远市','蒙自市','屏边苗族自治县','建水县','石屏县','弥勒市','泸西县','元阳县','红河县','金平苗族瑶族傣族自治县','绿春县','河口瑶族自治县'],
    ...
    [// ['710100', '710200', '710300', '710400', '710500', '710600', '710700', '710800', '710900', '711100', '711200', '711300', '711400', '711500', '711700', '711900', '712100', '712400', '712500', '712600', '712700', '712800'],
      ...
      ['新兴区','前金区','芩雅区','盐埕区','鼓山区','旗津区','前镇区','三民区','左营区','楠梓区','小港区','苓雅区','仁武区','大社区','冈山区','路竹区','阿莲区','田寮区','燕巢区','桥头区','梓官区','弥陀区','永安区','湖内区','凤山区','大寮区','林园区','鸟松区','大树区','旗山区','美浓区','六龟区','内门区','杉林区','甲仙区','桃源区','那玛夏区','茂林区','茄萣区'],
      ...
      ['中区','东区','南区','西区','北区','北屯区','西屯区','南屯区','太平区','大里区','雾峰区','乌日区','丰原区','后里区','石冈区','东势区','和平区','新社区','潭子区','大雅区','神冈区','大肚区','沙鹿区','龙井区','梧栖区','清水区','大甲区','外埔区','大安区'],
      ['金沙镇','金湖镇','金宁乡','金城镇','烈屿乡','乌坵乡'],
      ['南投市','中寮乡','草屯镇','国姓乡','埔里镇','仁爱乡','名间乡','集集镇','水里乡','鱼池乡','信义乡','竹山镇','鹿谷乡'],
      ['仁爱区','信义区','中正区','中山区','安乐区','暖暖区','七堵区'],
      ['东区','北区','香山区'],
      ['东区','西区'],
      ['万里区','金山区','板桥区','汐止区','深坑区','石碇区','瑞芳区','平溪区','双溪区','贡寮区','新店区','坪林区','乌来区','永和区','中和区','土城区','三峡区','树林区','莺歌区','三重区','新庄区','泰山区','林口区','芦洲区','五股区','八里区','淡水区','三芝区','石门区'],
      ['宜兰市','头城镇','礁溪乡','壮围乡','员山乡','罗东镇','三星乡','大同乡','五结乡','冬山乡','苏澳镇','南澳乡','钓鱼台'],
      ['竹北市','湖口乡','新丰乡','新埔镇','关西镇','芎林乡','宝山乡','竹东镇','五峰乡','横山乡','尖石乡','北埔乡','峨眉乡'],
      ['中坜市','平镇市','龙潭乡','杨梅市','新屋乡','观音乡','桃园市','龟山乡','八德市','大溪镇','复兴乡','大园乡','芦竹乡'],
      ['竹南镇','头份镇','三湾乡','南庄乡','狮潭乡','后龙镇','通霄镇','苑里镇','苗栗市','造桥乡','头屋乡','公馆乡','大湖乡','泰安乡','铜锣乡','三义乡','西湖乡','卓兰镇'],
      ['彰化市','芬园乡','花坛乡','秀水乡','鹿港镇','福兴乡','线西乡','和美镇','伸港乡','员林镇','社头乡','永靖乡','埔心乡','溪湖镇','大村乡','埔盐乡','田中镇','北斗镇','田尾乡','埤头乡','溪州乡','竹塘乡','二林镇','大城乡','芳苑乡','二水乡'],
      ['番路乡','梅山乡','竹崎乡','阿里山乡','中埔乡','大埔乡','水上乡','鹿草乡','太保市','朴子市','东石乡','六脚乡','新港乡','民雄乡','大林镇','溪口乡','义竹乡','布袋镇'],
      ['斗南镇','大埤乡','虎尾镇','土库镇','褒忠乡','东势乡','台西乡','仑背乡','麦寮乡','斗六市','林内乡','古坑乡','莿桐乡','西螺镇','二仑乡','北港镇','水林乡','口湖乡','四湖乡','元长乡'],
      ['屏东市','三地门乡','雾台乡','玛家乡','九如乡','里港乡','高树乡','盐埔乡','长治乡','麟洛乡','竹田乡','内埔乡','万丹乡','潮州镇','泰武乡','来义乡','万峦乡','崁顶乡','新埤乡','南州乡','林边乡','东港镇','琉球乡','佳冬乡','新园乡','枋寮乡','枋山乡','春日乡','狮子乡','车城乡','牡丹乡','恒春镇','满州乡'],
      ['台东市','绿岛乡','兰屿乡','延平乡','卑南乡','鹿野乡','关山镇','海端乡','池上乡','东河乡','成功镇','长滨乡','金峰乡','大武乡','达仁乡','太麻里乡'],
      ['花莲市','新城乡','太鲁阁','秀林乡','吉安乡','寿丰乡','凤林镇','光复乡','丰滨乡','瑞穗乡','万荣乡','玉里镇','卓溪乡','富里乡'],
      ['马公市','西屿乡','望安乡','七美乡','白沙乡','湖西乡'],
      ['南竿乡','北竿乡','莒光乡','东引乡'],
    ],
    [//['810100', '810200', '810300']
      ['中西区','湾仔','东区','南区'],
